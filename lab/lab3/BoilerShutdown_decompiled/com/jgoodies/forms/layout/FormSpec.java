...
public abstract class FormSpec implements Serializable
{
    ...
    static {
        ...
        VALUES = new DefaultAlignment[] { FormSpec.LEFT_ALIGN, FormSpec.RIGHT_ALIGN, FormSpec.TOP_ALIGN, FormSpec.BOTTOM_ALIGN, FormSpec.CENTER_ALIGN, FormSpec.FILL_ALIGN };
