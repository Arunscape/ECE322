...
public class FixedTest{
    ...
    public void maxTest(){
        ...
        for (int i=0; i<1000; i+=1){
            ...
            Arrays.sort(input);
            assertEquals(input[n-1], Fixed.max(input));
        }
    }
    ...
    public void minTest(){
        ...
        for (int i=0; i<1000; i+=1){
            ...
            Arrays.sort(input);
            assertEquals(input[0], Fixed.min(input));
        }
    }
    ...
    public void sumTest() {
        ...
        for (int i=0; i<1000; i+=1){
            ...
            assertEquals(Arrays.stream(input).sum(), Fixed.sum(input), 1e-10); // tolerance of 1e-10 because of error that accumilates with double
        }
    }
    ...
    public void stddevTest(){
        ...
        double ret1 = Fixed.stddev(input1);
        assertEquals(exp1, ret1, 1e-10);

        double ret2 = Fixed.stddev(input2);
    ...
    public void arrayAddTestSameLength() {
        ...
        for (int i=0; i<1000; i+=1){
            ...
            assertArrayEquals(expected, Fixed.arrayAdd(d1, d2), 1e-10); // tolerance of 1e-10 because of error that accumilates with double
        }
    }
    ...
    public void arrayAddTestDifferentLength(){
        ...
        assertThrows(AssertionError.class, () -> Fixed.arrayAdd(d1, d2));
        assertThrows(AssertionError.class, () -> Fixed.arrayAdd(d2, d1));
    ...
    public void negateTest(){
        ...
        for (int i=0; i<1000; i+=1){
            ...
            assertArrayEquals(Arrays.stream(input).map(x->-x).toArray(), Fixed.arrayNegate(input));
        }
    }
    ...
    public void arraySubractTestSameLength() {
        ...
        for (int i=0; i<1000; i+=1){
            ...
            double[] expected = new double[n];
            Arrays.setAll(expected, index -> d1[index] - d2[index]);
            assertArrayEquals(expected, Fixed.arraySubtract(d1, d2), 1e-10); // tolerance of 1e-10 because of error that accumilates with double
        }
    }
    ...
    public void arraySubtractTestDifferentLength(){
        ...
        assertThrows(AssertionError.class, () -> Fixed.arraySubtract(d1, d2));
        assertThrows(AssertionError.class, () -> Fixed.arraySubtract(d2, d1));
    ...
    public void distanceTest(){
        // different lengths
        assertThrows(AssertionError.class, () -> Fixed.distance(new double[]{1}, new double[]{1,2}));
        assertThrows(AssertionError.class, () -> Fixed.distance(new double[]{}, new double[]{1, 2}));

        // more than 2 dimensions
        assertThrows(AssertionError.class, ()-> Fixed.distance(new double[]{1, 2, 3}, new double[]{4, 5, 6}));

        double ret1 = Fixed.distance(new double[]{-1, -2}, new double[]{3, 4});
        double ret2 = Fixed.distance(new double[]{6, 7}, new double[]{-8, -9});
    ...
    public void arrayDeviationTest(){
        ...
        assertArrayEquals(expected1, Fixed.arrayDeviation(input1));

        double[] expected2 = {-1.5, 2.5, -4.5, -2.5, 3.5, -0.5, 4.5, -3.5, 1.5, 0.5} ;
        assertArrayEquals(expected2, Fixed.arrayDeviation(input2));
